-- Snowflake Multimodal Agents Lab - FINAL WORKING Setup
-- This script creates the necessary database objects for the VARIANT storage approach
...
CREATE OR REPLACE TABLE multimodal_documents (
    ...
    width INTEGER,
    height INTEGER,
    embedding VARIANT, -- Store as VARIANT (direct Python object)
