-- Working Snowflake Setup Script for Multimodal Agents Lab
-- This version uses ARRAY type for storage (VECTOR type cannot be used in VALUES clauses)
...
-- Create table with ARRAY type for embeddings (VECTOR cannot be used in VALUES)
CREATE OR REPLACE TABLE multimodal_documents (
    id STRING DEFAULT UUID_STRING(),
    key STRING NOT NULL,
    width INTEGER,
    height INTEGER,
    embedding ARRAY, -- Use ARRAY type - VECTOR cannot be inserted directly
