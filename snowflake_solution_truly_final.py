#!/usr/bin/env python3
"""
Snowflake Multimodal Agents Lab - TRULY FINAL Working Solution

This version uses STRING storage and STRTOK_TO_ARRAY conversion.
This is the ONLY approach that works with Snowflake's current limitations.
"""
...
# Step 3: Load embeddings and store in Snowflake (STRING approach - the ONLY one that works)
...
def generate_answer(conn, gemini_client, LLM, user_query: str, images: List = [], serverless_url: str = "") -> str:
    ...
    if (
        ...
        serverless_url = "https://www.wired.com/story/ai-psychosis-is-rarely-psychosis-at-all/"
